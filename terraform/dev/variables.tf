...
locals {
  CONFIG_LIST = {
    ...
    coreweb = {
      ...
      inbound = [
        ["TCP", "10.10.10.0/32", "2122", "SSH@BASTION"]
      ]
      outbound = []
      storage = {
        sw = {
    ...
    metaap = {
      ...
      inbound = [
        ...
        ["TCP", "211.204.87.46/32", "8080", "TOMCAT@PROJECT_SITE"], ["TCP", "10.10.10.0/32", "2122", "SSH@BASTION"],
        ["TCP", "221.204.87.46/32", "2122", "SSH@PROJECT_SITE"]
      ]
      outbound = [
