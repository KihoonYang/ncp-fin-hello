...
config.gitlab = {};
config.gitlab.url = process.env.GITLAB_URL || 'http://gitlab-webservice-default.gitlab.svc.cluster.local:8080';
...
config.gitlab.access_token = process.env.ACCESS_TOKEN || 'glpat-yzNTyQsxr8**********';
config.gitlab.id = process.env.PROJECT_ID || '44';
